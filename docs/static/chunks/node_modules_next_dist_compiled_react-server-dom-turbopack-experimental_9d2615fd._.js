...
"[project]/node_modules/next/dist/compiled/react-server-dom-turbopack-experimental/cjs/react-server-dom-turbopack-client.browser.development.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function getIOShortName(ioInfo, description, env, rootEnv) {
        ...
        if (1 < descMaxLength) {
            ...
            if (0 < l && l <= descMaxLength) rootEnv = " (" + description + ")";
                ...
                l - slashIdx < descMaxLength && (rootEnv = " (" + description.slice(slashIdx + 1, l) + ")");
            }
        }
    ...
    function resolvePostponeDev(response, id, reason, stack, env) {
        reason = buildFakeCallStack(response, stack, env, !1, Error.bind(null, reason || ""));
        stack = response._debugRootTask;
        reason = null != stack ? stack.run(reason) : reason();
        reason.$$typeof = REACT_POSTPONE_TYPE;
        stack = response._chunks;
        (env = stack.get(id)) ? triggerErrorOnChunk(response, env, reason) : stack.set(id, createErrorChunk(response, reason));
    }
    ...
    function resolveIOInfo(response, id, model) {
        var chunks = response._chunks, chunk = chunks.get(id);
        chunk ? (resolveModelChunk(response, chunk, model), "resolved_model" === chunk.status && initializeModelChunk(chunk)) : (chunk = new ReactPromise("resolved_model", model, response), chunks.set(id, chunk), initializeModelChunk(chunk));
    ...
    function processFullStringRow(response, id, tag, row) {
        switch(tag){
            ...
            case 69:
                ...
                chunk ? triggerErrorOnChunk(response, chunk, tag) : row.set(id, createErrorChunk(response, tag));
                break;
            case 84:
...
"[project]/node_modules/next/dist/compiled/react-server-dom-turbopack-experimental/client.browser.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/next/dist/compiled/react-server-dom-turbopack-experimental/client.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_next_dist_compiled_react-server-dom-turbopack-experimental_9d2615fd._.js.map