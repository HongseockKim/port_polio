...
export const PROJET_DATA: Record<ProjectKey, ProjectData> =     {
    sild:{
        ...
        images:[`${process.env.BASE_PATH}img/project/sild/sild_1.jpg`,`${process.env.BASE_PATH}img/project/sild/sild_2.jpg`,`${process.env.BASE_PATH}img/project/sild/sild_3.jpg`],
    ...
    BankX:{
        ...
        images:[`${process.env.BASE_PATH}img/project/bankx/bankx_3.jpg`,`${process.env.BASE_PATH}img/project/bankx/bankx_1.jpg`,`${process.env.BASE_PATH}img/project/bankx/bankx_2.jpg`],
    ...
    haru:{
        ...
        images:[`${process.env.BASE_PATH}img/project/haru/haru_1.jpg`,`${process.env.BASE_PATH}img/project/haru/haru_2.jpg`,`${process.env.BASE_PATH}img/project/haru/haru_3.jpg`],
    ...
    ThankyouMarket:{
        ...
        images:[`${process.env.BASE_PATH}img/project/tankyou/tankyou_1.jpg`,`${process.env.BASE_PATH}img/project/tankyou/tankyou_2.jpg`],
    ...
    liveTo:{
        ...
        images:[`${process.env.BASE_PATH}img/project/liveto/live_1.jpg`,`${process.env.BASE_PATH}img/project/liveto/live_2.jpg`,`${process.env.BASE_PATH}img/project/liveto/live_3.jpg`],
    ...
    lxhausys:{
        ...
        images:[`${process.env.BASE_PATH}img/project/lg/lg_1.jpg`,`${process.env.BASE_PATH}img/project/lg/lg_2.jpg`,`${process.env.BASE_PATH}img/project/lg/lg_3.jpg`],
    ...
    samsung:{
        ...
        images:[`${process.env.BASE_PATH}img/project/samsung/samsung.jpg`,],
    ...
    pickkoadmin:{
        ...
        images:[`${process.env.BASE_PATH}img/project/pickko/pickko_1.jpg`,`${process.env.BASE_PATH}img/project/pickko/pickko_2.jpg`,`${process.env.BASE_PATH}img/project/pickko/pickko_3.jpg`],
    ...
    pickkokiosk:{
        ...
        images:[`${process.env.BASE_PATH}img/project/zaksim/kiosk_1.jpg`,`${process.env.BASE_PATH}img/project/zaksim/kiosk_2.jpg`,`${process.env.BASE_PATH}img/project/zaksim/kiosk_3.jpg`],
    ...
    caring:{
        ...
        images:[`${process.env.BASE_PATH}img/project/caring/care_1.jpg`,],
