    ...
    const projects = [
        ...
        },
        {
            ...
            readmeContent:{
                ...
                background:'기존 레거시 HTML 기반 과 ASP 로 개발된 학술대회 live 스트리밍 플랫폼을 React 기반으로 이전 하여 개발하였습니다. 코로나 19 이후 비대면 학술대회가 증가함에 따라, 따분한 사이트 를 3D 기술을 사용하여 버츄얼 스테이지 구현과 의류기기 부스장 을 구현 하여 홍보 하였습니다.',
